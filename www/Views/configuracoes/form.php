...
<section class="config-wrapper py-4 py-lg-5">
    ...
    <div class="config-card card border-0 shadow-lg">
        <div class="card-body p-4 p-lg-5">
            <?php if (!empty($erros)): ?>
                <div class="alert alert-danger config-alert d-flex align-items-start gap-3">
            ...
            <form action="<?php echo base_url('configuracoes/salvar'); ?>" method="POST" class="needs-validation" novalidate>
                ...
                <div class="config-section p-4 p-md-5">
